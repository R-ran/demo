  ...
  const fallbackAboutSections = [
    {
      ...
      icon: "Award" as const,
      image: "/why.jpg",
      imageAlt: "Engineering team collaborating on XINHONG geotechnical solutions",
    ...
    },
    {
      ...
      imageAlt: "Interior of XINHONG's advanced anchor bolt manufacturing facility",
    ...
    },
    {
      ...
      image: "/history.jpg",
      imageAlt: "Historical display of XINHONG project milestones",
    ...
    },
    {
      ...
      imageAlt: "Certificates highlighting XINHONG quality and safety achievements",
